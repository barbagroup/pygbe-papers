...
This iso-type was not found to have a preferred orientation in previous studies, unlike the iso-type {\small IgG1} whose larger dipole moment was assumed to make it easier to control. Our results show a high-probability and favorable orientation for {\small IgG2a} with positive surface charge of 0.1C/m$^{2}$ and 37mM salt concentration. 
