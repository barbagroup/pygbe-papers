...
We also performed this calculation placing protein \gb 5\AA~ away from the surface, and the results did not vary.
...
Placing a surface with charge $\sigma=0.1$C/m$^2$ next to \ig 2a, the average absolute value of the dimensionless potential is 1.3, and it exceeds 1 in $51\%$ of the triangles, so we can expect the linearized Poisson Boltzmann to give a good approximation of the solvation energy.
