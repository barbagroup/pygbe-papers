...
For example, we ran a calculation on an isolated \ig 2 immersed in a solvent with 37mM of salt ($\kappa = 0.0625$) using our boundary element code with the parameters from Table \ref{table:params5}. 
...
Then, we compared the solvation energy of the isolated \ig 2 obtained with the linear and non-linear Poisson-Boltzmann models using APBS.\cite{BakerETal2001} In this case, we used a $150\times 150\times 150$\AA\ mesh with 449$^3$ nodes, and the energies differed by $0.02\%$.
