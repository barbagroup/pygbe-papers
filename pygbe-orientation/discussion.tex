...
For example, we ran a calculation on an isolated \ig 2a immersed in a solvent with 37mM of salt ($\kappa = 0.0625$\AA$^{-1}$), using our boundary element code with the parameters from Table \ref{table:params5}. 
