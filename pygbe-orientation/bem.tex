...
The boundary-integral representation of the implicit-solvent model is a popular choice to compute solvation energies of proteins.\cite{YoonLenhoff1990, Juffer1991a, LuETal2006, BajajETal2011, AltmanBardhanWhiteTidor09, GengKrasny2013, CooperBardhanBarba2013} One notable example is the work by Lenhoff\cite{YoonLenhoff1992} where they include the effect of charged surfaces, however, their formulation considers only infinite-sized surfaces. 
