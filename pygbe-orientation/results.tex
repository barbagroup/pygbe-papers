...
\begin{figure*}
   ...
   \subfloat[Side view for $\alpha_{\text{tilt}} = 36^{\circ}$ and $\alpha_{\text{rot}} = 300^{\circ}$]{\includegraphics[width=0.4\textwidth]{Figure14d.pdf} \label{fig:1IGT_3D_sig-02_kap0125_til056-rot040}}\\
   ...
   \subfloat[Side view for $\alpha_{\text{tilt}} = 46^{\circ}$ and $\alpha_{\text{rot}} = 340^{\circ}$]{\includegraphics[width=0.4\textwidth]{Figure14f.pdf} \label{fig:1IGT_3D_sig-005_kap003125_til116-rot160}}\\
   ...
   \subfloat[Side view for $\alpha_{\text{tilt}} = 40^{\circ}$ and $\alpha_{\text{rot}} = 40^{\circ}$]{\includegraphics[width=0.4\textwidth]{Figure14h.pdf} \label{fig:1IGT_3D_sig-02_kap003125_til124-rot140}}
...
\begin{figure*}
   ...
   \subfloat[Side view for $\alpha_{\text{tilt}} = 32^{\circ}$ and $\alpha_{\text{rot}} = 100^{\circ}$]{\includegraphics[width=0.4\textwidth]{Figure15d.pdf} \label{fig:1IGT_3D_sig02_kap0125_til064-rot260}}\\
   ...
   \subfloat[Side view for $\alpha_{\text{tilt}} = 64^{\circ}$ and $\alpha_{\text{rot}} = 260^{\circ}$]{\includegraphics[width=0.4\textwidth]{Figure15h.pdf} \label{fig:1IGT_3D_sig02_kap003125_til076-rot160}}
