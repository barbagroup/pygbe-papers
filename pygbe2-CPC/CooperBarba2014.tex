...
We derived an analytical solution for a spherical charged surface interacting with a spherical molecule, extended the implicit-solvent model used in the open-source code PyGBe, then completed a grid-convergence study to build evidence on the correctness and usefulness of our approach.
