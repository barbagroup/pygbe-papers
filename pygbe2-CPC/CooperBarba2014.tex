...
PyGBe solves the boundary integral integral formulation of the Poisson-Boltzmann equation, discretized with surface elements. At its core is a treecode-accelerated Krylov iterative solver, resulting in $O(N \log N)$ scaling, and further acceleration on hardware with \gpu s. It computes solvation, surface and interaction free energies, providing a framework for studying the effect of electrostatics on adsorption.
