...
For completeness, we have added the iteration count of the Krylov solver and time required to calculate the solvation and surface energies, in figures \ref{fig:1PGB_time} and \ref{fig:1PGB_iterations}.
